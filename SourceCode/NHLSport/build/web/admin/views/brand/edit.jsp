                ...
                <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                    ...
                    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
                        <ul class="u-list-inline g-color-gray-dark-v6">
                            ...
                            <li class="list-inline-item g-mr-10">
                                <a class="u-link-v5 g-color-gray-dark-v6 g-color-secondary--hover g-valign-middle" href="#!">Brands</a>
                                <i class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
                            </li>
                            <li class="list-inline-item g-mr-10">
                                <a class="u-link-v5 g-color-gray-dark-v6 g-color-secondary--hover g-valign-middle" href="#!">Edit</a>
                            </li>
                        </ul>
                    </div>
                    <!-- End Breadcrumb-v1 -->
                            ...
                            <div class="col-md-8" style="margin: 0 auto">
                              <!-- Basic Text Inputs -->
                                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                    <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mb-20">Edit Brand</h3>

                                    <form action="${context}/Admin/Brands/Update" method="post">
                                        <input type="text" hidden value="<c:out value="${brand.brandId}" />" name="id" readonly />
                                        <!-- Default Input -->
                                        <div class="form-group g-mb-30">
                                            <label class="g-mb-10" for="inputGroup-1_1">Brand Name</label>
                                            <div class="g-pos-rel">
                                                <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
                                                    <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                                </span>
                                                <input required="required" id="inputGroup-1_1" value="<c:out value="${brand.name}" />" name="brandName" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Enter brand name">
                                            </div>
                                        </div>
                                        <!-- End Default Input -->
                                        ...
                                        <div class="form-group g-mb-30">
                                            ...
                                            <label class="form-check-inline u-check g-mr-20 mx-0 mb-0" style="vertical-align: text-bottom;">
                                                <input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0"  ${brand.status == true ? "checked" : ""}  value="true" name="status" type="checkbox">
