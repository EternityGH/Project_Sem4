        ...
        <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-pa-20">
                    ...
                    <form action="${context}/Admin/Storage/AddStorage"  method="post">
                        <div class="row">
                            <!-- 1-st column -->
                            <div class="col-md-9">
                                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <c:forEach items="${yasuo}" var="url">  
                                            <img src="${context}/assets/images/products/${url}" class=""/>
                                        </c:forEach>
                                ...
                                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                    ...
                                    <div class="form-group g-mb-30">
                                        ...
                                        <div class="g-pos-rel">
                                            ...
                                            <input class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Enter price" value="${list.quantity}" readonly="">
                                        </div>
                                    </div>
                                    <!-- End Default Input -->
                                    <!-- Default Input -->
                                    <div class="form-group g-mb-30">
                                        <label class="g-mb-10">Enter quantity of products </label>
                                        <div class="g-pos-rel">
                                            <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
                                                <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                            </span>
                                            <input name="quanAdd"  class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="number"  placeholder="Enter quantity" min="1" max="1000" required="" title="Please enter digit [0-1000]" >
                                        </div>
                                    </div>
                                    <!-- End Default Input -->
                                </div>
