        ...
        <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-pa-20">
                    ...
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">All Categories</h1>

                    <div class="media-md align-items-center g-mb-30">
                        <div class="d-flex g-mb-15 g-mb-0--md">
                            <h3 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">Table Categories</h3>
                        </div>
                            ...
                            <table class="js-datatable table u-table--v3 u-editable-table--v1 g-color-black" data-dt-info="#datatableInfo1" data-dt-search="#datatableSearch1" data-dt-entries="#datatableEntries1" data-dt-is-show-paging="true" data-dt-pagination="datatablePagination1"
                                ...
                                <thead>
                                    <tr>
                                        <th>
                                <div class="media">
                                    <div class="d-flex align-self-center">Category Id</div>
                                ...
                                <th>
                                <div class="media">
                                    <div class="d-flex align-self-center">Category Name</div>
                                ...
                                <tbody>
                                    <c:forEach var="cat" items="${listCat}">
                                        <tr class="item-${cat.categoryId}">
                                            <td class="text-left"><c:out value="${cat.categoryId}" /></td>
                                            ...
                                            <td class="text-right">
                                                <div class="g-pos-rel g-top-3 d-inline-block">
                                                    <a id="dropDown1Invoker" class="u-link-v5 g-line-height-0 g-font-size-24 g-color-gray-light-v6 g-color-secondary--hover" href="#" aria-controls="dropDown-${cat.categoryId}" aria-haspopup="true" aria-expanded="false" data-dropdown-event="click" data-dropdown-target="#dropDown-${cat.categoryId}">
                                                        <i class="hs-admin-more-alt"></i>
                                                    </a>

                                                    <div id="dropDown-${cat.categoryId}" class="u-shadow-v31 g-pos-abs g-right-0 g-z-index-2 g-bg-white u-dropdown--css-animation u-dropdown--hidden u-dropdown--reverse-y" aria-labelledby="dropDown1Invoker">
                                                        <ul class="list-unstyled g-nowrap mb-0">
                                                            <li>
                                                                <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="${context}/Admin/Categories/Edit?id=${cat.categoryId}">
