        ...
        <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-pa-20">
                    ...
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">Manage Storages</h1>
                            ...
                            <table class="js-datatable table u-table--v3 u-editable-table--v1 g-color-black" data-dt-info="#datatableInfo1" data-dt-search="#datatableSearch1" data-dt-entries="#datatableEntries1" data-dt-is-show-paging="true" data-dt-pagination="datatablePagination1"
                                ...
                                <thead>
                                    <tr>
                                        <th>
                                <div class="media">
                                    <div class="d-flex align-self-center">Product Image</div>
                                ...
                                <tbody>
                                    <c:forEach var="prod" items="${list}">
                                        <c:if test="${prod.productId.status == 'True'}">
                                            <tr class="item-${prod.productId} contentPage">
                                                <td class="text-left">
                                                    <c:set var="url" value="${fn:split(prod.productId.imageUrl, ';')}"/>
                                                    <a href="${context}/Products/Detail?id=${prod.productId.productId}" class="view"><img src="${context}/assets/images/products/${url[0]}" class="img-fluid"  style="width: 30%"/></a>                      
                                                </td>
                                                <td><c:out value="${prod.productId.productName}" /></td>
                                                <td><c:out value="${prod.productId.categoryId.name}" /></td>
                                                <td><c:out value="${prod.productId.brandId.name}" /></td>
                                                <td><c:out value="${prod.quantity}" /></td>
                                                <td class="text-right">
                                                    <div class="g-pos-rel g-top-3 d-inline-block">
                                                        <a id="dropDown1Invoker" class="u-link-v5 g-line-height-0 g-font-size-24 g-color-gray-light-v6 g-color-secondary--hover" href="#" aria-controls="dropDown-${prod.storageId}" aria-haspopup="true" aria-expanded="false" data-dropdown-event="click" data-dropdown-target="#dropDown-${prod.storageId}">
                                                            <i class="hs-admin-more-alt"></i>
                                                        </a>

                                                        <div id="dropDown-${prod.storageId}" class="u-shadow-v31 g-pos-abs g-right-0 g-z-index-2 g-bg-white u-dropdown--css-animation u-dropdown--hidden u-dropdown--reverse-y" aria-labelledby="dropDown1Invoker">
                                                            <ul class="list-unstyled g-nowrap mb-0">
                                                                <li>
                                                                    <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="${context}/Admin/Storage/GetViewAdd?id=${prod.storageId}">
                                                                        <i class="hs-admin-pencil g-font-size-18 g-color-gray-light-v6 g-mr-10 g-mr-15--md"></i>
                                                                        Add More
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a data-id="${prod.storageId}" class="btn-delete d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="${context}/Admin/Storage/Update?id=${prod.storageId}">
                                                                        <i class="hs-admin-pencil g-font-size-18 g-color-gray-light-v6 g-mr-10 g-mr-15--md"></i>
                                                                        Update
                                                                    </a>
                                                                </li>
