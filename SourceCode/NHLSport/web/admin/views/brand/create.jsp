                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8" style="margin: 0 auto">
                            ...
                            <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mb-20">Create Category</h3>

                                <form action="${context}/Admin/Brands/Store" method="post">
                                    <!-- Default Input -->
                                    <div class="form-group g-mb-30">
                                        ...
                                        <div class="g-pos-rel">
                                            ...
                                            <input required="required" id="inputGroup-1_1" name="brandName" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Enter category name">
                                        </div>
                                    </div>
                                    <!-- End Default Input -->
