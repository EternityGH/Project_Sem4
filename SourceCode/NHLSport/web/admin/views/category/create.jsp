                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8" style="margin: 0 auto">
                            ...
                            <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                ...
                                <form action="${context}/Admin/Categories/Store" method="post">
                                    <!-- Default Input -->
                                    <div class="form-group g-mb-30">
                                        ...
                                        <div class="g-pos-rel">
                                            ...
                                            <input required="required" id="inputGroup-1_1" name="categoryName" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Enter category name">
                                        </div>
                                    </div>
                                    <!-- End Default Input -->
