                            ...
                            <div class="col-md-8" style="margin: 0 auto">
                              <!-- Basic Text Inputs -->
                                <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                                    <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mb-20">Reply Messages</h3>

                                    <form action="${context}/Admin/Contacts/SendReply" method="post">
                                        <input type="text" value="${contact.id}" name="id" hidden >
                                        <!-- Default Input -->
                                        <div class="form-group g-mb-30">
                                            <label class="g-mb-10" for="inputGroup-1_1">Customer Name</label>
                                            <div class="g-pos-rel">
                                                <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
                                                    <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                                </span>
                                                <input id="inputGroup-1_1" name="cusName" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" value="${contact.name}" readonly placeholder="Enter category name">
                                            </div>
                                        </div>
                                        <!-- End Default Input -->

                                        <div class="form-group g-mb-30">
                                            <label class="g-mb-10" for="inputGroup-1_2">Customer Email</label>
                                            <div class="g-pos-rel">
                                                <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
                                                    <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                                </span>
                                                <input id="inputGroup-1_2" name="cusEmail" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" value="${contact.email}" readonly placeholder="Enter category name">
                                            </div>
                                        </div>
                                        <div class="form-group g-mb-30">
                                            <label class="g-mb-10" for="inputGroup-1_3">Messages</label>

                                            <textarea id="inputGroup-1_3" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4" rows="3" readonly placeholder="Text area">
                                                ${contact.description}
                                            </textarea>
                                        </div>
                                        <div class="form-group g-mb-30">
                                            <label class="g-mb-10" for="inputGroup-1_3">Reply</label>

                                            <textarea id="inputGroup-1_3" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4" rows="3" name="reply" placeholder="Enter reply">
