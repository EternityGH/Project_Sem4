    ...
    <main class="container-fluid px-0 g-pt-65">
        <div class="row no-gutters g-pos-rel g-overflow-x-hidden">
            ...
            <div class="col g-ml-45 g-ml-0--lg g-pb-65--md">
                ...
                <div class="g-pa-20">
                    <c:if test="${sessionScope.NotyMessage != null}">
                        <div class="noty_bar noty_type__success noty_theme__unify--v1 g-mb-25">
                            <div class="noty_body">
                                ...
                                <div><c:out value="${sessionScope.NotyMessage}" /></div>
                                <c:remove var="NotyMessage" scope="session" />
                            </div>
                        </div>
                    </c:if>
                    <div class="noty noty_bar noty_type__success noty_theme__unify--v1 g-mb-25">
                        <div class="noty_body">
                            <div class="g-mr-20">
                                <div class="noty_body__icon">
                                    <i class="hs-admin-check"></i>
                            ...
                            <div>Delete product successfully</div>
                        </div>
                    </div>
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">All Products</h1>

                    <div class="media-md align-items-center g-mb-30">
                        <div class="d-flex g-mb-15 g-mb-0--md">
                            <h3 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">Table Products</h3>
                        </div>
                        ...
                        <div class="media d-md-flex align-items-center ml-auto">
                            ...
                            <div class="d-flex g-ml-15 g-ml-55--md">
                                <div class="input-group g-pos-rel g-width-320--md">
                                    <input id="datatableSearch1" class="form-control g-font-size-default g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-rounded-20 g-pl-20 g-pr-50 g-py-10" type="text" placeholder="Search for name">
                    ...
                    <div class="g-mb-40">
                        <div class="table-responsive">
                            <table class="js-datatable table u-table--v3 u-editable-table--v1 g-color-black" data-dt-info="#datatableInfo1" data-dt-search="#datatableSearch1" data-dt-entries="#datatableEntries1" data-dt-is-show-paging="true" data-dt-pagination="datatablePagination1"
                                   data-dt-page-length="5" data-dt-is-responsive="true" data-dt-pagination-classes="list-inline text-right mb-0" data-dt-pagination-items-classes="list-inline-item g-hidden-sm-down" data-dt-pagination-links-classes="u-pagination-v1__item u-pagination-v1-2 g-bg-secondary--active g-color-white--active g-brd-gray-light-v7 g-brd-secondary--hover g-brd-secondary--active g-rounded-4 g-py-8 g-px-15"
                                ...
                                <thead>
                                    <tr>
                                        <th>
                                <div class="media">
                                    <div class="d-flex align-self-center">Product Id</div>
                                ...
                                <th>
                                <div class="media">
                                    <div class="d-flex align-self-center">Product Name</div>
                                ...
                                <th>
                                <div class="media">
                                    <div class="d-flex align-self-center">Brand</div>
                                ...
                                <tbody>
                                    <c:forEach var="prod" items="${listProd}">
                                        <tr class="item-${prod.productId} contentPage">
                                            <td class="text-left"><c:out value="${prod.productId}" /></td>
                                            <td><c:out value="${prod.productName}" /></td>
                                            <td><c:out value="${prod.categoryId.name}" /></td>
                                            <td><c:out value="${prod.brandId.name}" /></td>
                                            <td>
                                                <c:if test = "${prod.status == 'True'}">
                                            ...
                                            <td class="text-right">
                                                <div class="g-pos-rel g-top-3 d-inline-block">
                                                    <a id="dropDown1Invoker" class="u-link-v5 g-line-height-0 g-font-size-24 g-color-gray-light-v6 g-color-secondary--hover" href="#" aria-controls="dropDown-${prod.productId}" aria-haspopup="true" aria-expanded="false" data-dropdown-event="click" data-dropdown-target="#dropDown-${prod.productId}">
                                                        <i class="hs-admin-more-alt"></i>
                                                    </a>

                                                    <div id="dropDown-${prod.productId}" class="u-shadow-v31 g-pos-abs g-right-0 g-z-index-2 g-bg-white u-dropdown--css-animation u-dropdown--hidden u-dropdown--reverse-y" aria-labelledby="dropDown1Invoker">
                                                        <ul class="list-unstyled g-nowrap mb-0">
                                                            <li>
                                                                <a class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="${context}/Admin/Products/Edit?id=${prod.productId}">
                                                                    <i class="hs-admin-pencil g-font-size-18 g-color-gray-light-v6 g-mr-10 g-mr-15--md"></i>
                                                                    Edit
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a data-id="${prod.productId}" class="btn-delete d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="${context}/Admin/Products/Status?id=${prod.productId}&status=${prod.status}">
                                                                    <i class="hs-admin-wheelchair g-font-size-18 g-color-gray-light-v6 g-mr-10 g-mr-15--md"></i>
                                                                    <c:if test = "${prod.status == 'True'}">
                                                                        Disable
                                                                    </c:if>
                                                                    <c:if test = "${prod.status == 'False'}">
